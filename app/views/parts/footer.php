			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<form class="modal-authorization__form col-12" action="#">
						<div class="row">
							<input class="modal-authorization__input col-12" type="email" name="email" placeholder="Email*">
							<input class="modal-authorization__input col-12" type="password" name="password" placeholder="Пароль*">
						</div>
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<form class="modal-registration__form col-12" action="#">
						<div class="row">
							<input class="modal-registration__input col-12" type="text" name="name" placeholder="ФИО*">
							<input class="modal-registration__input col-12" type="email" name="email" placeholder="Email*">
							<input class="modal-registration__input col-12 phone" type="tel" name="phone" placeholder="Телефон*">
							<input class="modal-registration__input col-12" type="password" name="password" placeholder="Пароль*">
						</div>
