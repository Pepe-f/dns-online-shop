    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="swiper-wrapper">
                            <?php if (!empty($gallery)) { ?>
                                ...
                                <?php foreach ($gallery as $item) { ?>
                                    <div class="swiper-slide product-images__slide <?php if ($index === 0) {
                        ...
                        <?php if (!empty($gallery)) { ?>
                            <?php foreach ($gallery as $item) { ?>
                                <div class="swiper-slide product-images__preview-slide">
                                    <a data-fancybox="gallery" data-src="<?= $item["img"] ?>"
                                       href="<?= $item["img"] ?>">
            ...
            <div class="col-lg-6 col-12 product-characteristics">
                <div class="row">
                    <div class="col-12">
                        <span class="product-characteristics__vendor">Артикул: <?= $product["article"] ?></span>
                    </div>
		                <div class="col-12">
			                  <?php if ($product["qty"] > 0) { ?>
                        <span class="product-characteristics__vendor">В наличии: <?= $product["qty"] ?> шт</span>
			                  <?php } else { ?>
				                  <span class="product-characteristics__vendor">Нет в наличии</span>
		                  <?php } ?>
		                </div>
                    <div class="col-12">
                        <h2 class="product-characteristics__name"><?= $product["name"] ?></h2>
                    </div>
                    <div class="col-12">
                        <div class="row align-items-center product-characteristics__actions">
                            <strong class="product-characteristics__price"><?= $product["price"] ?> ₽</strong>
                            <button class="button-fill button-fill--red product-characteristics__button button-cart"
                    ...
                    <div class="col-12">
                        <div class="row product-characteristics__list">
                            <div class="col-sm-6 col-12 product-characteristics__body">
                                <?php foreach ($characteristics as $characteristic) { ?>
                                    <div class="product-characteristics__item">
                                        <span class="product-characteristics__key"><?= $characteristic["name"] ?></span>
                                        <div class="product-characteristics__dash"></div>
        ...
        <div class="container">
            <div class="product-description__body">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="product-description__text"><?= $product["content"] ?></p>
                    </div>
                </div>
            </div>
        </div>
